  func.func @partial_solution_12_body(%0 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %1 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]> attributes {from_weighted_dsl, number = "4_74_137"} {
    ...
    %7 = "transfer.cmp"(%3, %5) {predicate = 0 : index} : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.select"(%7, %2, %6) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.select"(%7, %8, %4) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.clear_low_bits"(%8, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.countl_one"(%6) : (!transfer.integer) -> !transfer.integer
    %12 = "transfer.and"(%10, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
