  func.func @partial_solution_13_body(%0 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %1 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]> attributes {from_weighted_dsl, number = "4_513_149"} {
    ...
    %7 = "transfer.neg"(%6) : (!transfer.integer) -> !transfer.integer
    %8 = "transfer.countl_one"(%5) : (!transfer.integer) -> !transfer.integer
    %9 = "transfer.urem"(%4, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.udiv"(%8, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
