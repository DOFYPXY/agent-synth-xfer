  func.func @partial_solution_20_body(%0 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %1 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]> attributes {number = "1_1679_77"} {
    ...
    %6 = "transfer.countl_one"(%5) : (!transfer.integer) -> !transfer.integer
    %7 = "transfer.mul"(%2, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.add"(%7, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.clear_low_bits"(%2, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.urem"(%6, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
