  func.func @partial_solution_6_body(%0 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %1 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]> attributes {number = "2_1693_46"} {
    ...
    %8 = "transfer.set_sign_bit"(%2) : (!transfer.integer) -> !transfer.integer
    %9 = "transfer.or"(%6, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.and"(%9, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.and"(%10, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "transfer.clear_high_bits"(%7, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
