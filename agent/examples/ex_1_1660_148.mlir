  func.func @partial_solution_4_body(%0 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %1 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]> attributes {from_weighted_dsl, number = "1_1660_148"} {
    ...
    %6 = "transfer.set_high_bits"(%3, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.and"(%6, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.neg"(%4) : (!transfer.integer) -> !transfer.integer
    %9 = "transfer.and"(%2, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.shl"(%5, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
