  func.func @partial_solution_10_body(%0 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %1 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]> attributes {from_weighted_dsl, number = "4_3_92"} {
    ...
    %6 = "transfer.and"(%5, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.and"(%6, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.srem"(%3, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.and"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
