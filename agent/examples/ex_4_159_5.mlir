  func.func @partial_solution_11_body(%0 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %1 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]> attributes {number = "4_159_5"} {
    ...
    %8 = "transfer.smin"(%2, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.udiv"(%2, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.clear_high_bits"(%9, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.and"(%3, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "transfer.clear_high_bits"(%7, %11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "transfer.umin"(%10, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %14 = "transfer.countl_one"(%12) : (!transfer.integer) -> !transfer.integer
