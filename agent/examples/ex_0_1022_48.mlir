  func.func @partial_solution_5_body(%0 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %1 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]> attributes {number = "0_1022_48"} {
    ...
    %8 = "transfer.or"(%7, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.and"(%4, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.clear_sign_bit"(%2) : (!transfer.integer) -> !transfer.integer
    %11 = "transfer.clear_high_bits"(%5, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "transfer.cmp"(%4, %11) {predicate = 6 : index} : (!transfer.integer, !transfer.integer) -> i1
    %13 = "transfer.select"(%12, %5, %5) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %14 = "transfer.shl"(%13, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %15 = "transfer.and"(%9, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
