  func.func @partial_solution_5_body(%0 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %1 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]> attributes {from_weighted_dsl, number = "2_1591_166"} {
    ...
    %8 = "transfer.and"(%5, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.countr_one"(%4) : (!transfer.integer) -> !transfer.integer
    %10 = "transfer.and"(%8, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.countl_zero"(%4) : (!transfer.integer) -> !transfer.integer
    %12 = "transfer.umax"(%11, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "transfer.clear_low_bits"(%2, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %14 = "transfer.add"(%6, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %15 = "transfer.clear_low_bits"(%9, %12) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %16 = "transfer.and"(%13, %15) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %17 = "transfer.and"(%14, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
