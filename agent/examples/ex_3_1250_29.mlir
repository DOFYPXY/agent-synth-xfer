  func.func @partial_solution_8_body(%0 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %1 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]> attributes {number = "3_1250_29"} {
    ...
    %8 = "transfer.smax"(%7, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.clear_high_bits"(%5, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.add"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.srem"(%7, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "transfer.or"(%9, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "transfer.neg"(%12) : (!transfer.integer) -> !transfer.integer
    %14 = "transfer.or"(%5, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %15 = "transfer.shl"(%12, %13) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %16 = "transfer.srem"(%11, %14) : (!transfer.integer, !transfer.integer) -> !transfer.integer
