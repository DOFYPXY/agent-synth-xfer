...
void register_sconst_range_bindings(py::module_ &m) {
  register_sconst_range_bindings_bw_1_8(m);
  register_sconst_range_bindings_bw_9_16(m);
  register_sconst_range_bindings_bw_17_24(m);
  register_sconst_range_bindings_bw_25_32(m);
}
